...
Current baseline (2026-05-26 **S133 CLOSE**). **v0.6.1 LIVE on GitHub** (cut mid-session at commit `c5a27b73`). Full suite **21,585 pass / 0 fail / 170 skip / 1 todo across 794 files** (net delta +1 from S131/S132 baseline 21,584 — through major adds and retires: E-FN-003 +4 / E-SCHEMA-003 +7 / Step A META_BUILTINS +2 / D Step B rewriteBunEval −12 = +1).
