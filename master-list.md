...
**Last updated:** 2026-04-25 (S40 close — Bun.SQL Phase 1 + Phase 2, SPEC §8/§44 reconciliation, SQL placeholder fix arc 4 contexts (lift / return / reactive-decl-CPS / mountHydrate-client), Phase 4d Step 8 .expr deletion + strict cleanup, LSP arc L1+L2+L3+L4 (L5 dropped). **7,825 pass / 40 skip / 0 fail** across 370 files with ~27,971 expects. ~108 commits pushed in 2 waves.)
