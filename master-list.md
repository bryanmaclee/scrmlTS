...
**Last updated:** 2026-05-05 (S61 close — **Phase A1a (lex+parse) COMPLETE**; 20 sub-steps done; A1b/A1c next)

**Tests (current):** **8,902 pass / 44 skip / 1 todo / 0 fail / 8,947 across 439 files** (A1a-COMPLETE baseline; +28 pass / +1 skip / +1 todo vs S60 close; +182 pass / +1 skip / +1 todo vs S58 close pre-A1a). Pre-commit subset ~8,212 / 33 / 0.
