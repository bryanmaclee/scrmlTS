...
### G-NOT-NEGATION-UNENFORCED — `E-TYPE-045` (`not` used as boolean negation) is SPEC-`SHALL`-error but the compiler accepts it silently — `NEW S186; MED; spec-vs-impl (E-TYPE-045 under-enforced)`
